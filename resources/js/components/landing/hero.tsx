                ...
                <div className="transform transition-all duration-800 delay-100 translate-y-0 opacity-100">
                  ...
                  <div className="mb-6 sm:mb-8 lg:mb-12">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight uppercase">
                      <span className="title-word title-word-1 inline-block text-white font-bold opacity-100 translate-y-0">THE LITIGATORS</span>
                      <span className="title-word title-word-2 inline-block ml-4 text-[#00A0E9] font-bold font-sans tracking-wider glow-text opacity-100 translate-y-0">LITIGATION</span>
                    </h1>
                  </div>
                  ...
                  <div className="intro-text-container text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light leading-relaxed">
                    <div className="intro-phrase intro-phrase-1 mb-2">
                      <span className="text-white">High Stakes </span>
                      <span className="text-[#00A0E9] font-medium glow-text-subtle">Commercial Litigators</span>
                      <span className="text-white">,</span>
                    </div>
                    <div className="intro-phrase intro-phrase-2 mb-2">
                      <span className="text-white">Specialising in; </span>
                      <span className="text-[#00A0E9] font-medium glow-text-subtle">Fraud</span>
                      <span className="text-white">, </span>
                      <span className="text-[#00A0E9] font-medium glow-text-subtle">Injunction</span>
                      <span className="text-white">,</span>
                    </div>
                    <div className="intro-phrase intro-phrase-3">
                      <span className="text-[#00A0E9] font-medium glow-text-subtle">Crisis Management</span>
                      <span className="text-white"> & </span>
                      <span className="text-[#00A0E9] font-bold glow-text">More</span>
                    </div>
                  </div>
                </div>
              </div>
