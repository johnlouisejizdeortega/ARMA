        ...
        <main className="w-full">
          <div className="mb-16">
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center rounded-lg">
                  <div className="text-center px-6">
                    ...
                    <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                      A dispute resolution powerhouse offering expertise with a distinctly different approach.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="w-full max-w-4xl mx-auto text-center py-20 px-4">
              <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-6">About ARMA Litigation</h1>
              ...
              <p className="text-2xl md:text-3xl text-[#00A0E9] font-semibold mb-4">
            ...
            {/* Minimalist Vertical Highlight Layout */}
            <section className="w-full flex flex-col gap-0">
              {/* Peer Recognition */}
              <div className="w-full py-14 px-4 md:px-0 border-b border-white/10 text-center bg-white/[0.02]">
                <i className="fa-solid fa-handshake text-[#00A0E9] text-6xl mb-6"></i>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 uppercase">PEER RECOGNITION</h2>
              ...
              <div className="w-full py-14 px-4 md:px-0 border-b border-white/10 text-center bg-white/[0.01]">
                <i className="fa-solid fa-gavel text-[#00A0E9] text-6xl mb-6"></i>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 uppercase">JUDICIAL RECOGNITION</h2>
                <p className="text-gray-200 text-xl md:text-2xl max-w-2xl mx-auto">
              ...
              {/* Jurisdiction */}
              <div className="w-full py-14 px-4 md:px-0 border-b border-white/10 text-center bg-white/[0.02]">
                <i className="fa-solid fa-scale-balanced text-[#00A0E9] text-6xl mb-6"></i>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 uppercase">JURISDICTION</h2>
                <p className="text-gray-200 text-xl md:text-2xl max-w-2xl mx-auto mb-2">
                  We operate at the highest levels:
                </p>
                <ul className="list-disc list-inside text-gray-300 text-lg md:text-xl max-w-xl mx-auto mb-0">
              ...
              {/* Clientele */}
              <div className="w-full py-14 px-4 md:px-0 border-b border-white/10 text-center bg-white/[0.01]">
                <i className="fa-solid fa-users text-[#00A0E9] text-6xl mb-6"></i>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 uppercase">CLIENTELE</h2>
                <p className="text-gray-200 text-xl md:text-2xl max-w-2xl mx-auto mb-2">
                  We act for:
                </p>
                <ul className="list-disc list-inside text-gray-300 text-lg md:text-xl max-w-xl mx-auto mb-0">
              ...
              <div className="w-full py-14 px-4 md:px-0 border-b border-white/10 text-center bg-white/[0.02]">
                <i className="fa-solid fa-lightbulb text-[#00A0E9] text-6xl mb-6"></i>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 uppercase">SPECIALIST EXPERTISE</h2>
                <p className="text-gray-200 text-xl md:text-2xl max-w-2xl mx-auto mb-2">
              ...
              {/* AI Technology */}
              <div className="w-full py-14 px-4 md:px-0 text-center bg-white/[0.01]">
                <i className="fa-solid fa-robot text-[#00A0E9] text-6xl mb-6"></i>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 uppercase">AI TECHNOLOGY</h2>
                <p className="text-gray-200 text-xl md:text-2xl max-w-2xl mx-auto">
